...
(function (f) {
  ...
  var define, module, exports; return function e(t, n, r) {
    ...
    1: [function (require, module, exports) { }, {}], 2: [function (require, module, exports) {
    ...
    }, { "./debug": 6, "_process": 16 }], 6: [function (require, module, exports) {
      ...
      (function (process, global) {
        ...
        (function (global, factory) {
          (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : factory(global.RSVP = global.RSVP || {});
          ...
          */
          ...
          PromiseHash.prototype._validateInput = function (input) {
            return input && (typeof input === "undefined" ? "undefined" : _typeof(input)) === 'object';
          };
      ...
      */
    ...
    }, { "./is-object": 19, "./request": 21, "./request-base": 20, "emitter": 3 }], 19: [function (require, module, exports) {
      /**
    ...
    }, { "./formdata.js": 24, "./index.js": 25, "./localstorage.js": 26, "./websocket.js": 27, "./xmlhttprequest.js": 28 }], 24: [function (require, module, exports) {
    ...
    }, { "./formdata.js": 24, "./localstorage.js": 26, "./websocket.js": 27, "./xmlhttprequest.js": 28, "object-assign": 15 }], 26: [function (require, module, exports) {
    ...
    }, { "event-target-shim": 9, "object-assign": 15 }], 28: [function (require, module, exports) {
      var assign = require('object-assign');
      var EventTarget = require('event-target-shim');
      var FormData = require('./formdata.js');
          ...
          value: function send(data) {
            ...
            if (data instanceof FormData) {
              ...
              var restData = entries.filter(function (entry) {
                ...
                return assign(result, _defineProperty2({}, entry[0], entry[1]));
              }, {});
              wx.uploadFile({
                url: this._url,
                name: blobs[0][0],
    ...
    }, { "./formdata.js": 24, "event-target-shim": 9, "object-assign": 15 }], 29: [function (require, module, exports) {
    ...
    }, { "./utils": 58, "_process": 16, "underscore": 22 }], 31: [function (require, module, exports) {
      (function (global) {
        var _ = require('underscore');
    ...
    }, { "../promise": 46, "localstorage-memory": 12, "react-native": 1, "underscore": 22 }], 32: [function (require, module, exports) {
    ...
    }, { "./av": 30, "./localstorage": 43 }], 34: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "./request": 50, "underscore": 22 }], 35: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 22 }], 36: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 22 }], 37: [function (require, module, exports) {
      (function (global) {
        var _ = require('underscore');
            ...
            set: function set() {
              ...
              var set = function set(attrName, value) {
                switch (attrName) {
                  ...
                  case 'base64':
                  case 'metaData':
                    _this4.attributes[attrName] = value;
                    break;
                  default:
                    // File 并非一个 AVObject，不能完全自定义其他属性，所以只能都放在 metaData 上面
                    _this4.attributes.metaData[attrName] = value;
                    break;
                }
              };
              ...
              if (!this._previousSave) {
                if (this._source) {
                  this._previousSave = this._source.then(function (_ref) {
                    var data = _ref.data,
                      type = _ref.type;
                    return _this5._fileToken(type).then(function (uploadInfo) {
                      var uploadPromise = void 0;
                      switch (uploadInfo.provider) {
                        case 's3':
                          uploadPromise = s3(uploadInfo, data, _this5, options);
                          break;
                        case 'qcloud':
                          uploadPromise = cos(uploadInfo, data, _this5, options);
                          break;
                        case 'qiniu':
                        default:
                          uploadPromise = qiniu(uploadInfo, data, _this5, options);
                          break;
                      }
                  ...
                  this._previousSave = AVRequest('files', this.attributes.name, null, 'post', data).then(function (response) {
                    _this5.attributes.name = response.name;
                    _this5.attributes.url = response.url;
                    _this5.id = response.objectId;
                    if (response.size) {
                      _this5.attributes.metaData.size = response.size;
                    }
                    return _this5;
                  });
                }
    ...
    }, { "./browserify-wrapper/parse-base64": 32, "./error": 35, "./promise": 46, "./request": 50, "./uploader/cos": 54, "./uploader/qiniu": 55, "./uploader/s3": 56, "underscore": 22 }], 38: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 22 }], 39: [function (require, module, exports) {
      require('weapp-polyfill/auto-polyfill');

      module.exports = require('./index');
    }, { "./index": 40, "weapp-polyfill/auto-polyfill": 23 }], 40: [function (require, module, exports) {
      /*!
       ...
       */
    }, { "./acl": 29, "./av": 30, "./cache": 33, "./cloudfunction": 34, "./error": 35, "./event": 36, "./file": 37, "./geopoint": 38, "./init": 41, "./insight": 42, "./localstorage": 43, "./object": 44, "./op": 45, "./promise": 46, "./push": 47, "./query": 48, "./relation": 49, "./role": 51, "./search": 52, "./status": 53, "./user": 57, "./version": 59, "underscore": 22 }], 41: [function (require, module, exports) {
      var AV = require('./av');
      ...
      */
    ...
    }, { "./av": 30, "./request": 50 }], 42: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 35, "./request": 50, "underscore": 22 }], 43: [function (require, module, exports) {
      var _ = require('underscore');
      var Promise = require('./promise');
    ...
    }, { "./browserify-wrapper/localStorage": 31, "./promise": 46, "underscore": 22 }], 44: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 35, "./request": 50, "./utils": 58, "underscore": 22 }], 45: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 22 }], 46: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "rsvp": 17, "underscore": 22 }], 47: [function (require, module, exports) {
      var AVRequest = require('./request').request;
    ...
    }, { "./request": 50 }], 48: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
          ...
          */
          ...
          include: function include(keys) {
            ...
            _(arguments).forEach(function (keys) {
              _this7._include = _this7._include.concat(ensureArray(keys));
            });
            return this;
          },
          ...
          select: function select(keys) {
            ...
            requires(keys, 'undefined is not a valid key');
            _(arguments).forEach(function (keys) {
              _this8._select = _this8._select.concat(ensureArray(keys));
            });
            return this;
          },
    ...
    }, { "./error": 35, "./request": 50, "./utils": 58, "underscore": 22 }], 49: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 22 }], 50: [function (require, module, exports) {
      (function (process) {
        ...
        var _require3 = require('./utils'),
          getSessionToken = _require3.getSessionToken;
    ...
    }, { "./av": 30, "./cache": 33, "./error": 35, "./promise": 46, "./utils": 58, "_process": 16, "debug": 5, "md5": 13, "superagent": 18, "underscore": 22 }], 51: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
    ...
    }, { "./error": 35, "underscore": 22 }], 52: [function (require, module, exports) {
      var _ = require('underscore');
      var AVRequest = require('./request').request;
    ...
    }, { "./request": 50, "underscore": 22 }], 53: [function (require, module, exports) {
      var _ = require('underscore');
      var AVRequest = require('./request').request;
      ...
      var getUser = function getUser() {
        ...
        return AV.User.currentAsync().then(function (currUser) {
          return currUser ? currUser : AV.User._fetchUserBySessionToken(options.sessionToken);
        });
      };
        ...
        AV.Status.prototype = {
          ...
          send: function send() {
            ...
            return getUserPointer(options).then(function (currUser) {
              var query = _this9.query.toJSON();
              query.className = _this9.query.className;
              var data = {};
              data.query = query;
              _this9.data = _this9.data || {};
              _this9.data.source = _this9.data.source || currUser;
              data.data = _this9._getDataJSON();
              data.inboxType = _this9.inboxType || 'default';

              return AVRequest('statuses', null, null, 'POST', data, options.sessionToken);
            }).then(function (response) {
              _this9.id = response.objectId;
              _this9.createdAt = AV._parseDate(response.createdAt);
              return _this9;
            });
          },
    ...
    }, { "./request": 50, "underscore": 22 }], 54: [function (require, module, exports) {
      var request = require('superagent');
    ...
    }, { "../promise": 46, "debug": 5, "superagent": 18 }], 55: [function (require, module, exports) {
      var request = require('superagent');
      var Promise = require('../promise');
    ...
    }, { "../promise": 46, "debug": 5, "superagent": 18 }], 56: [function (require, module, exports) {
      var request = require('superagent');
    ...
    }, { "../promise": 46, "superagent": 18 }], 57: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
      var Promise = require('./promise');
          ...
          _linkWith: function _linkWith(provider, data) {
            ...
            if (data) {
              ...
              return provider.authenticate().then(function (result) {
                return _this10._linkWith(provider, result);
              });
            }
          },
    ...
    }, { "./error": 35, "./promise": 46, "./request": 50, "underscore": 22 }], 58: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 22 }], 59: [function (require, module, exports) {
